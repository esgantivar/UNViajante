...
class BootStrap {
	...
	def init = { servletContext ->
		...
		agregarPoblacion(new PopulationCenter (idPopulationCenter: "44001", namePCenter: "RIOHACHA"))
		...
		agregarPoblacion(new PopulationCenter (idPopulationCenter: "99001", namePCenter: "PUERTO CARREÑO"))
	...
	def agregarCompañia(company, poblacion){
		def pob = PopulationCenter.findByNamePCenter(poblacion.toUpperCase())
